...
<title>Verify Account | Shop Mobiphone</title>
...
input#firstname:focus, input#email:focus, input#password1:focus, input#password2:focus,
	input#firstname:hover, input#email:hover, input#password1:hover, input#password2:hover
	{
	color: #fff;
...
<%-- 	  <form action="verify" method="post">
		<div class="auth-form" style="background-color: white;">
			<div class="auth-form-container">
				<a href="client/home"><h5 class="auth-form-title"
					style="text-align: center; padding-top: 20px;">Welcome to FlatShop</h5>
				</a>
				...
				<div class="auth-form-form" style="margin-top: 15px; margin-bottom: -13px;">
 ...
 <h1 class="w3ls">Verify</h1>
	<div class="content-w3ls" style="border-radius: 20px 20px 20px 20px;">
		<div class="content-agile1"
			style="background-image: url(resource/client/images/bgdt2.jpg);">
			<h2 class="agileits1">GROUP 20</h2>
		...
		<div class="content-agile2">
			<form action="verify" method="post">
				...
				<a href="client/home"><h5 class="auth-form-title" style="font-size: 30px; text-align: center; color: white; padding-bottom: 50px">Welcome to
					MoBiPhone - GR 20</h5></a>
					
				<p style="font-size: 18px; text-align: center; color: white;">
					We just sent a confirmation code over to
					 <span style="font-weight: bold; color: white;">${sessionScope.emailRegister}</span>
				</p>
				...
				<div>
						<c:if test="${resend != null}">
							<div style="display: flex; margin-bottom: 2px; color: #00FF00; ">
								<i class="material-icons" style="font-size: 19px;margin-left: 200px">&#xe88f;</i>
								<span  style="margin-left: 2px;">Check Your Email.</span>
							</div>
						</c:if>
						
						<c:if test="${verifyFail != null}">
							<div style=" margin-top: 10px;margin-bottom:20px;margin-left: 30px; color: red; text-align: center;">
								<i style="font-size:18px" class="fa">&#xf071;</i>
								<span style="margin-left: 2px; ">${verifyFail}</span>
							</div>
						</c:if>
						...
						<c:if test="${verifySuccess != null}">
							<div style="display: flex; ;margin-left: 150px ; margin-bottom: 2px; color: #339900;">
								<i style='font-size:19px' class='fas'>&#xf058;</i>
								<span>${verifySuccess}</span> <a href="login" style="margin-left: 10px;"> Login </a>
							</div>
						</c:if>
					...
					<input type="text" id="email" name="code" placeholder="Enter code"
						equired="required">
				</div>


					
					<div style="font-size: 17px; text-align: center; color: white;">
					<span >Did'nt work? <a style="font-size: 17px ;color: red;" href="resend-code">Send me another code.</a>
					</span>
				    </div>
				
						 
					<input type="submit" class="login" value="Confirm"> 
			...
			<p class="wthree w3l">You Can Login By Following Way</p>
	...
	<p class="copyright w3l">
		© 2021 Official Signup Form. All Rights Reserved | Design by <a
