	...
	<div class="content-w3ls" style="border-radius: 20px 20px 20px 20px;">
		...
		<div class="content-agile2">
			<form action="register" method="post">
				...
				<p style="color: #FFFFFF; margin-top: -20px; text-align:center ; margin-bottom: 5px;">${error}</p>
				...
				<div class="form-control agileinfo">
					<input type="password" class="lock" name="password"
						placeholder="Password" id="password1" required="required">
				</div>


				<div class="form-control agileinfo">
					<input type="password" class="lock" name="repassword"
						placeholder="Confirm Password" id="password2" required="required">
				</div>


				<input type="submit" class="login" value="Register"> <a
					href="login" class="black">Login</a>
