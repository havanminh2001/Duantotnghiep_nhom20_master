...
<body style="background-image: url(resource/client/images/bg.jpg);">
	...
	<h1 class="w3ls">GRUP 20 - SINGUP</h1>
...
<a href="register" class="singin">Register</a>
				<div>
					<img style="width: 100px ; height: 100px; padding-left: 40% " 
				...
				<p style="color: red; margin-top: -15px; margin-left: 3x; text-align:center; margin-bottom: 5px;">${err}</p>
			 

				
				<input type="submit" class="login" value="Login">	
				<a href="client/home" class="black">Cancel</a>
