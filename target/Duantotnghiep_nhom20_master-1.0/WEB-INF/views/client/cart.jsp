...
<title>Welcome to | Shop Mobi</title>
									...
									<tbody>
										<c:forEach items="${sessionScope.cart}" var="cart">
											<tr>
												...
												<td>
													<h5 style="color: #41B314; font-weight: bold;">${cart.value.unitPrice} VND</h5>
													<c:if
														test="${cart.value.productDTO.saleDTO.salePercent > 0}">
														<p
															style="font-size: 16px; padding-top: 7px; text-decoration: line-through;"> ${cart.value.productDTO.price} VND</p>
													</c:if>
												</td>
												<td>
												...
												<td>
													<h5>
														<strong class="red" style="font-weight: bold;">
															...
															cart.value.quantity}.00 VND </strong>
													</h5>
												</td>
												<td><a
								...
								<div class="row">
									...
									<div class="col-md-4 col-sm-6">
										<div class="shippingbox">
											<div class="subtotal">
												<h5>Sub Total:</h5>
												<span>${sessionScope.subTotal} VND</span>
											</div>
											 
											<div class="grandtotal">
												<h5>GRAND TOTAL</h5>
												<span>${sessionScope.grandTotal} VND</span>
											</div>
											<c:if test="${sessionScope.user != null}">
												<c:if
											...
											<c:if test="${sessionScope.user == null}">
												<a href="../login"><button>Payment order</button></a>
											</c:if>
										</div>
									</div>
								</div>
