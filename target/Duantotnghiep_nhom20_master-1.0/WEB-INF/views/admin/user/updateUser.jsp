					...
					<div class="panel panel-headline">
						<div class="panel-heading"
							...
							<a class="btn btn-warning" href="user-list"
								style="background-color: #BBBBBB; padding: 8px 10px; text-decoration: none; border: none;margin-right: 20px; height: 40px;">Back</a>
						</div>
								...
								<table style="margin: auto; margin-right: 30px;"
									...
									<tr>
										...
										<c:if test="${user.avatar != null}">
												<img src="../download?image=${user.avatar}"													class="avatar img-circle" style="width: 15%;">
											</c:if> 
											<input type="file" name="avatarFile" style="margin-left: 5px; margin-top: 30px;"/>
