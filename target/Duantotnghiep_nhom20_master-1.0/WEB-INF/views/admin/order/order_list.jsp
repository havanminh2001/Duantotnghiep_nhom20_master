...
<html>
<head>
<title>Manager Oder | Shop Mobiphone</title>
<meta charset="utf-8">
...
<body>
	...
	<div id="wrapper">
									...
									<div class="col-md-12">
										<div class="panel">
											<div class="panel-heading">
												<h3 class="panel-title">Oder List Manager</h3>
												<div class="right">
											</div>
														...
														<c:forEach items="${orders}" var="order" varStatus="loop">
															<tr>
																...
																<td><a href="order-details?orderId=${order.orderId}"
																	style="text-decoration: underline;">Invoice</a></td>
															</tr>
														</c:forEach>
													</tbody>
												</table>
		...
		<div class="container-fluid">
			<p class="copyright">
				&copy; 2021 <a href="https://www.themeineed.com" target="_blank">Group 20 - group of 20 - graduation project</a>. All Rights Reserved.
			</p>
		</div>
	</footer>
	</div>
