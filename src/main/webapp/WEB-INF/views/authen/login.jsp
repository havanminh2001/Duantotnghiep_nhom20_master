...
<title>Login | Shop Mobiphone</title>
...
<link href="../resource/css/authen.css" rel="stylesheet">
<style type="text/css">
@charset "ISO-8859-1";
...
<body style="background-image: url(resource/client/img/bg.jpg);">
	...
	<h1 class="w3ls">Hà Linh Store - Đăng Nhập</h1>
	<div class="content-w3ls" style="border-radius: 20px 20px 20px 20px;">
		...
		<div class="content-agile2">
			<form action="login" method="post">
				<a href="register" class="singin">Đăng Kí</a>
				<div></div>
				<a href="register" class="singin">Quên Mật Khẩu</a>
				<div>
					<img style="width: 50px; height: 50px; padding-left: 45%" 
						src="http://www.saigangroup.com/admin/img/download.png"
						alt="Flowers in Chania">
				</div>


				<div style="padding-top: 5px" class="form-control w3layouts">
				...
				<p
					style="color: red; margin-top: -15px; margin-left: 3x; text-align: center; margin-bottom: 5px;">${err}</p>



				<input type="submit" class="login" value="Đăng Nhập"> <a
					href="client/home" class="black">Cancel</a>
			...
			<p class="wthree w3l">Bạn có thể đăng nhập bằng những cách sau</p>
	...
	<p class="copyright w3l">
		Â© 2021 Official Signup Form. All Rights Reserved | Design by <a
			href="https://w3layouts.com/" target="_blank">Group 20</a>
	</p>
</body>
</html>