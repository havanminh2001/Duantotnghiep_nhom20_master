...
<body style="background-image: url(resource/client/img/bg.jpg);">


	<h1 class="w3ls">Xác Minh Tài Khoản</h1>
	<div class="content-w3ls" style="border-radius: 20px 20px 20px 20px;">
		<div class="content-agile1"
			style="background-image: url(resource/client/img/bg1.jpg); border-bottom-left-radius: 20px; border-top-left-radius: 20px">
			<h2 class="agileits1">Hà Linh Store</h2>
			<p class="agileits2">Hãy nâng tầm giá trị của bạn</p>
		</div>
		<div class="content-agile2">
			<form action="verify" method="post">

				<a href="client/home"><h5 class="auth-form-title"
						style="font-size: 30px; text-align: center; color: white; padding-bottom: 50px">Chào Mừng đến với
						Hà Linh Store</h5></a>

				<p style="font-size: 18px; text-align: center; color: white;">
					Chúng tôi vừa gửi một mã xác nhận tới <span
						style="font-weight: bold; color: white;">${sessionScope.emailRegister}</span>
				</p>
				...
				<div>
					<c:if test="${resend != null}">
						<div style="display: flex; margin-bottom: 2px; color: #00FF00;">
							<i class="material-icons"
								style="font-size: 19px; margin-left: 200px">&#xe88f;</i> <span
								style="margin-left: 2px;">Kiểm tra Mail.</span>
						</div>
					</c:if>

					<c:if test="${verifyFail != null}">
						<div
							style="margin-top: 10px; margin-bottom: 20px; margin-left: 30px; color: red; text-align: center;">
					...
					<c:if test="${verifySuccess != null}">
						<div
							style="display: flex;; margin-left: 150px; margin-bottom: 2px; color: #339900;">
				...
				<div class="form-control w3layouts">
					<input type="text" id="email" name="code" placeholder="Nhập mã gồm 6 chữ số"
						equired="required">
				</div>
				...
				<div style="font-size: 17px; text-align: center; color: white;">
					<span>Nó Không hoạt động? <a style="font-size: 17px; color: red;"
						href="resend-code">Gửi cho tôi một mã khác.</a>
					</span>
				</div>


				<input type="submit" class="login" value="Xác Nhận">
			...
			<p class="wthree w3l">Bạn có thể đăng nhập bằng các cách sau</p>
