...
<title>Register | Shop Mobiphone</title>
...
<body style="background-image: url(resource/client/img/bg.jpg); ">
	...
	<div class="content-w3ls" style="border-radius: 20px 20px 20px 20px;">
		...
		<div 
			class="content-agile2">
			<form action="register" method="post">



				<p
					style="color: #FFFFFF; margin-top: -20px; text-align: center; margin-bottom: 5px;">${error}</p>
				<div class="form-control w3layouts" style="padding-top: 40px">
					<input type="email" id="email" name="email"
						placeholder="mail@example.com" title="Nhập email của bạn ..."
				...
				<div class="form-control agileinfo">
					<input type="password" class="lock" name="password"
						placeholder="Nhập mật khẩu .." id="password1" required="required">
				</div>


				<div class="form-control agileinfo">
					<input type="password" class="lock" name="repassword"
						placeholder="Nhập lại mật khẩu .." id="password2" required="required">
				</div>


				<input type="submit" class="login" value="Đăng kí"> <a
					href="login" class="black">Đăng Nhập</a>
