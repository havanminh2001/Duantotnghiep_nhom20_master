	...
	<div id="wrapper">
		...
		<ul class="navbar-nav sidebar sidebar-light accordion"
			...
			<li class="nav-item active"><a class="nav-link" href="home">
					<i class="fas fa-fw fa-tachometer-alt"></i> <span>Trang Quản
						lý </span>
			</a></li>
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				aria-expanded="true" aria-controls="collapseBootstrap"> <i
					class="far fa-fw fa-window-maximize"></i> <span>Cửa Hàng</span>
			</a>
				<div id="collapseBootstrap" class="collapse"
					aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<h6 class="collapse-header">Cửa hàng</h6>
						<a class="collapse-item" href="shop-phone">Cửa Hàng Linhstore</a>
					</div>
				</div></li>
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				data-toggle="collapse" data-target="#collapseForm"
				aria-expanded="true" aria-controls="collapseForm"> <i
					class="fab fa-fw fa-wpforms"></i> <span>Quản Lý Sản Phẩm</span>
			</a>
				<div id="collapseForm" class="collapse"
					aria-labelledby="headingForm" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<h6 class="collapse-header">Sản phẩm & Phụ Kiện</h6>
						<a class="collapse-item" href="product-list">Sản Phẩm
							Linhstore</a> <a class="collapse-item" href="category-list">Danh
							Mục Sản Phẩm</a>
					</div>
				</div></li>
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				aria-expanded="true" aria-controls="collapseTable"> <i
					class="fas fa-fw fa-table"></i> <span>Quản Lý Tài Khoản</span>
			</a>
				<div id="collapseTable" class="collapse"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="user-admin">Tài Khoản Admin</a> <a
							class="collapse-item" href="user-custumer">Tài Khoản Người
							Dùng</a> <a class="collapse-item" href="user-list">Tất Cả Tài
							Khoản</a>
					</div>
				</div></li>
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				aria-expanded="true" aria-controls="collapsePage"> <i
					class="fas fa-fw fa-columns"></i> <span>Quản Lý Đơn Đặt Hàng</span>
			</a>
				<div id="collapsePage" class="collapse"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="order-list">Tất Cả Đơn</a> <a
							class="collapse-item" href="order-pending">Đơn Chưa Xác Nhận</a>
						<a class="collapse-item" href="order-success">Đơn Đã Xác Nhận</a>
						<a class="collapse-item" href="order-list">Đơn Đang Giao</a> <a
							class="collapse-item" href="order-list">Đơn Đã Giao</a>
						...
						<li class="nav-item dropdown no-arrow"><a
							...
							<div
								...
								<a href="user-update?userId=${user.userId}"
									...
									class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i> Trang
									Cá Nhân
