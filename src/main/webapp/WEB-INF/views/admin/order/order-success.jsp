...
<body id="page-top">
	...
	<div class="container-fluid" id="container-wrapper">
		<div class="d-sm-flex align-items-center justify-content-between mb-4">
			<h1 class="h3 mb-0 text-gray-800">Đơn Hàng Đã Xác Nhận</h1>
		</div>
						...
						<div class="col-lg-12">
							<div class="card mb-4">
								<div
									...
									<h6 class="m-0 font-weight-bold text-primary">Đã Xác Nhận</h6>
								</div>
								<div class="row">
						...
						<ul class="pagination">
							<c:forEach begin="0" end="${totalPage - 1}" var="i">
								<li class="page-item"><a class="page-link"
									...
									href="order-success?pageIndex=${i}">${i + 1}</a></li>
							</c:forEach>
						</ul>
					</nav>
